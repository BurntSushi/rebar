...
<!-- rebar report --statistic median --units throughput record/curated/2023-07-05/rust-regex.csv record/curated/2023-07-05/rust-regexinit.csv record/curated/2023-07-05/rust-regexold.csv --relative-path-to-repo-root ../../../ -->
### Summary
...
| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [rust/regex](../../../benchmarks/../engines/rust/regex) | 1.9.0 | 1.02 | 39 |
| [rust/regexold](../../../benchmarks/../engines/rust/regex-old) | 1.7.3 | 3.34 | 36 |
| [rust/regexinit](../../../benchmarks/../engines/rust/regex-init) | 1.0.0 | 4.35 | 34 |

#### Summary of compile-time benchmarks

| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [rust/regexold](../../../benchmarks/../engines/rust/regex-old) | 1.7.3 | 1.11 | 12 |
| [rust/regex](../../../benchmarks/../engines/rust/regex) | 1.9.0 | 1.13 | 14 |
| [rust/regexinit](../../../benchmarks/../engines/rust/regex-init) | 1.0.0 | 1.24 | 11 |
...
| - | - | - | - | - | - |
| rust/regex | 31.7 GB/s | **11.3 GB/s** | 32.4 GB/s | **9.1 GB/s** | 39.9 GB/s |
| rust/regexinit | 24.7 GB/s | 2.8 GB/s | **65.2 GB/s** | 756.5 MB/s | 6.8 GB/s |
| rust/regexold | **34.1 GB/s** | 8.0 GB/s | 33.4 GB/s | 6.6 GB/s | **40.1 GB/s** |
...
| Engine | sherlock-en | sherlock-casei-en | sherlock-ru | sherlock-casei-ru | sherlock-zh |
| - | - | - | - | - | - |
| rust/regex | 12.6 GB/s | **2.9 GB/s** | **6.7 GB/s** | **1528.4 MB/s** | 14.5 GB/s |
| rust/regexinit | 772.6 MB/s | 739.3 MB/s | 768.1 MB/s | 696.7 MB/s | 768.1 MB/s |
| rust/regexold | **13.6 GB/s** | 2.7 GB/s | 2.9 GB/s | 447.1 MB/s | **14.7 GB/s** |
...
| - | - | - | - | - |
| rust/regex | **163.3 MB/s** | **162.2 MB/s** | **1.50ms** | **5.28ms** |
| rust/regexinit | 143.2 MB/s | 415.3 KB/s | 1.88ms | 5.42ms |
| rust/regexold | 142.4 MB/s | 412.5 KB/s | 1.79ms | 6.02ms |
...
| - | - | - | - |
| rust/regex | **1645.0 MB/s** | **1605.0 MB/s** | 52.74us |
| rust/regexinit | 425.4 MB/s | 1586.9 MB/s | 53.94us |
| rust/regexold | 173.7 MB/s | 1244.3 MB/s | **40.10us** |
...
| - | - | - | - |
| rust/regex | **9.3 MB/s** | 269.95us | **93.9 MB/s** |
| rust/regexinit | 249.7 KB/s | 313.21us | - |
| rust/regexold | 243.4 KB/s | **240.53us** | - |
...
| rust/regexinit | 459.7 MB/s | 479.2 MB/s | 599.1 MB/s |
| rust/regexold | 434.2 MB/s | 472.2 MB/s | 603.7 MB/s |
...
| - | - | - |
| rust/regex | **333.6 MB/s** | 28.40us |
| rust/regexinit | 94.1 MB/s | 22.17us |
| rust/regexold | 94.5 MB/s | **18.74us** |
...
| - | - | - | - | - |
| rust/regex | **120.3 MB/s** | **19.5 MB/s** | 802.3 MB/s | 34.1 MB/s |
| rust/regexinit | 119.2 MB/s | 7.1 MB/s | **806.3 MB/s** | 34.8 MB/s |
| rust/regexold | 119.5 MB/s | 7.1 MB/s | 805.7 MB/s | **34.9 MB/s** |
...
| - | - | - | - | - |
| rust/regex | **1786.2 MB/s** | **1878.2 MB/s** | 84.53us | **15.26us** |
| rust/regexinit | 642.3 MB/s | 1769.9 MB/s | 86.65us | 20.08us |
| rust/regexold | 677.6 MB/s | 1379.4 MB/s | **73.48us** | 18.10us |
...
| - | - | - | - | - | - | - |
| rust/regex | **712.7 MB/s** | **643.2 MB/s** | **99.8 MB/s** | **825.6 MB/s** | 58.71us | **57.98us** |
| rust/regexinit | 603.1 MB/s | 529.4 MB/s | 19.7 MB/s | 825.6 MB/s | 40.96us | 68.40us |
| rust/regexold | 607.1 MB/s | 521.4 MB/s | 20.2 MB/s | 824.6 MB/s | **40.72us** | 66.77us |
...
| - | - | - |
| rust/regex | **109.2 MB/s** | 20.18us |
| rust/regexinit | 93.7 MB/s | 17.89us |
| rust/regexold | 84.1 MB/s | **14.38us** |
...
| - | - | - | - | - |
| rust/regex | **715.2 MB/s** | **180.3 MB/s** | 7.76ms | **15.94ms** |
| rust/regexinit | 26.8 KB/s | - | 13.06ms | - |
| rust/regexold | 29.7 KB/s | - | **7.61ms** | - |
...
| Engine | single | multi | compile-single | compile-multi |
| - | - | - | - | - |
| rust/regex | **132.4 MB/s** | **103.7 MB/s** | **2.43ms** | **2.95ms** |
| rust/regexold | 9.3 MB/s | - | 4.39ms | - |
...
| rust/regexinit | 14.0 MB/s | 7.6 MB/s | 1665.4 KB/s |
