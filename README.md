...
| ------ | ------- | ------------------------------ | --------------- |
| [rust/regex/meta](engines/rust/regex-automata) | 0.2.0 | 1.02 | 28 |
| [rust/regexold](engines/rust/regex-old) | 1.7.2 | 3.95 | 28 |

#### Summary of compile-time benchmarks

| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [rust/regexold](engines/rust/regex-old) | 1.7.2 | 1.10 | 12 |
| [rust/regex/meta](engines/rust/regex-automata) | 0.2.0 | 1.14 | 12 |
...
| Engine | single | compile-single |
| - | - | - |
| rust/regex/meta | **9.4 MB/s** | 256.76us |
...
| Engine | single | compile-single |
| - | - | - |
| rust/regex/meta | **710.8 MB/s** | **7.81ms** |
...
| Engine | single | compile-single |
| - | - | - |
| rust/regex/meta | **131.9 MB/s** | **2.44ms** |
